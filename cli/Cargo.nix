...
#   "generate" "-f" "cli/Cargo.toml" "-o" "cli/Cargo.nix"
  ...
  internal = rec {
    ...
    crates = {
      ...
      "forge" = rec {
        ...
        resolvedDefaultFeatures = [ "attestation" "default" "tameshi" ];
      };
      "form_urlencoded" = rec {
      ...
      "tameshi" = rec {
        ...
        version = "0.1.0";
        edition = "2021";
        sha256 = "1inba73vygr4ia8imy6z1sivlv9lnxz3fa3ls2myngm29kp603gl";
        authors = [
          "Pleme Team <team@pleme.io>"
        ];
        dependencies = [
